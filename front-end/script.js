...
//        }
  ...
  document.getElementById("searchcontrol").style.position = "relative";
  document.getElementById("searchcontrol").style.left = "50%";
  document.getElementById("searchcontrol").style.right = "50%";
  document.getElementById("searchcontrol").style.marginTop = "4%";
